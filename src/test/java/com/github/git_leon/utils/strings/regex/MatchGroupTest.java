package com.github.git_leon.utils.strings.regex;
...
public class MatchGroupTest {
    ...
    public void getTest0() {
        String expected = "Match{value='The', matchNumber=0, startingIndex=0, endingIndex=3}";
        String text = "The Quick Brown Fox";
        String patternString = "\\w+";
        ...
        String actualString = actualMatch.toString();
    ...
    public void getTest1() {
        String expected = "Match{value='Quick', matchNumber=1, startingIndex=4, endingIndex=9}";
        String text = "The Quick Brown Fox";
        String patternString = "\\w+";
